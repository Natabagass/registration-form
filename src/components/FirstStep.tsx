...
export default function FirstStep() {
    ...
    return (
        <>
            <div className='lg:mx-[100px] mx-[20px] font-Rajdhani lg:mt-[100px]'>
                <h1 className='font-medium text-[22px] mt-[50px] text-[#373F41] lg:text-[28px]'>Data Personal</h1>
                <h3 className='text-[#8F8F8F] font-Cairo text-[12px] w-[344px] lg:text-[16px]'>Masukkan data diri kamu untuk memulai kelas. Satu formulir hanya bisa digunakan untuk satu Mata Kuliah (Kursus), namun teman-teman bisa memilih beberapa Sesi Pelajaran di dalam satu mata kuliah tersebut.</h3>
                    ...
                    <form action="">
                        <div className='flex font-Cairo flex-col flex-wrap'>
                            ...
                            <div className='mb-6 relative'>
                                ...
                                <input type="text" name='email' className='border outline-none focus:ring-2  focus:text-[#3C64B1] focus:ring-[#3C64B1] w-[344px] lg:w-[484px] pl-[40px] text-[13px] mt-[10px] border-[#B0B1B0] rounded-2xl p-2' required placeholder='Misal: nama@gmail.com'/>
                            </div>
                            ...
                            <div className='mb-6 relative'>
                                ...
                                <input type="tel" name='phone' className='border w-[344px]  lg:w-[484px] pl-[40px] text-[13px] mt-[10px] border-[#B0B1B0] rounded-2xl p-2' required  placeholder='Tulis nomor handphone'/>
                            </div>

                            <label className='font-bold text-[16px]'>Program Studi</label>
                            <div className='mb-6 flex flex-row flex-wrap w-[344px]'>
                                {
                            ...
                            <div className='mb-6 relative'>
                                ...
                                <input type="text" name='fullname' className='border w-[344px] lg:w-[484px] pl-[40px] text-[13px] mt-[10px] border-[#B0B1B0] rounded-2xl p-2' required  placeholder='Tahun Angkatan'/>
                            </div>

                            <label className='font-bold text-[16px]'>Universitas</label>
                            <div className='mb-6 flex flex-row w-[344px] flex-wrap'>
                                {
                                    univ.map((data, index)=> {
                                        return(
                                            <div key={index} className='border border-[#B0B1B0] mr-[20px] rounded-2xl p-2 mt-[20px]'>
                                ...
                                <input type="text" name="program_studi" id="lainnya" className='-ml-[50px] mr-[20px] rounded-2xl p-2 pl-10 mt-[20px] border z-10' placeholder='Masukkan universitas'/>
                            </div>
                            ...
                            <div className='mb-6 flex flex-row w-[344px] flex-wrap'>
                                ...
                                <input type="text" name="program_studi" id="lainnya" className='-ml-[50px]  mr-[20px] rounded-2xl p-2 pl-10 pr-8 mt-[20px] border z-10' placeholder='Masukkan sumber lain'/>
                            </div>
                        </div>
                        <div>
