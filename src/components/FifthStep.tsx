...
export default function FifthStep() {
    ...
    return (
        <div className='flex flex-row'>
            ...
            <button type='submit' onClick={submitData} className='mr-0  block bg-[#5885E9] font-Cairo rounded-xl mt-[100px] mb-[50px] px-5 text-white p-3 font-bold shadow-effect'>Berikutnya</button>
        </div>
    )
}
